"""
9 de agosto de 2026.
voy a verificar que la funciona calculate RT_torch optimiza bien usando una bicapa ya optimizada y viendo que coincida.
"""
#%%
import sys
#import os
...
#%%
thickness, R_curve = calculate_RT_torch(stack_AA, materials, lams, weights=weight_am0, pol='s', th_0=0.0, num_starts=2000, num_epochs=50, lr=1.0, use_cuda=True)
print(thickness)
# %%
import matplotlib.pyplot as plt

plt.plot(lams,R_curve,label="Reflectancia calculada")
plt.xlabel('Wavelength (nm)')
plt.ylabel('Reflectance')
plt.title('Reflectance curve for Al2O3/anatase/Si stack')
plt.grid(True)
plt.legend()
plt.show()
# %%
