...
wl_exp, psi_deg, delta_deg = np.loadtxt('../../tmm-Rodrigo/Files/2026/05/21/TiO2_SiO2_Si.txt', skiprows=5, unpack=True)
...
wl_exp, psi_fit_deg, delta_fit_deg = np.loadtxt('../../tmm-Rodrigo/Files/2026/05/21/TiO2_SiO2_Si_fit.txt', skiprows=5, unpack=True)
